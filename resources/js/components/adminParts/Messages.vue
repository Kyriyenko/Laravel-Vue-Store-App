...
<div>
    ...
    <table v-show="isMessagesExist" class="table">
        ...
        <tr v-for="message in messages">
            ...
            <td>
                <button type="button"  v-on:click="getUserMessage(message)" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">DETAILS</button>
                <button v-on:click=" deleteMessage(message.id)" type="button" class="btn btn-danger mt-2">DELETE</button>
            </td>
        </tr>
        </tbody>
    </table>
